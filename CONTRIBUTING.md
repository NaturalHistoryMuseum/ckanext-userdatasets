...
Hi! Thanks for considering contributing to ckanext-userdatasets. :sauropod:
...
- [Issues](https://github.com/NaturalHistoryMuseum/ckanext-userdatasets/issues)
...
- [The documentation](https://ckanext-userdatasets.readthedocs.io)
- [The existing issues](https://github.com/NaturalHistoryMuseum/ckanext-userdatasets/issues?q=is:issue)
...
See GitHub's documentation for the basics on [how to create an issue](https://docs.github.com/en/issues/tracking-your-work-with-issues/creating-an-issue). Before you create an issue, please check the [existing issues](https://github.com/NaturalHistoryMuseum/ckanext-userdatasets/issues?q=is:issue) to see if it's already been raised.
...
Our documentation is generated using [MkDocs](https://www.mkdocs.org), then hosted on [Read the Docs](https://about.readthedocs.com). You can view the current documentation for this repository at [ckanext-userdatasets.readthedocs.io](https://ckanext-userdatasets.readthedocs.io).
